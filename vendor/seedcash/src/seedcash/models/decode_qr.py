...
from seedcash.helpers.ur2.crypto_psbt import unwrap_psbt_cbor
...
class DecodeQR:
    ...
    def get_data_psbt(self):
        if self.complete:
            if self.qr_type == QRType.PSBT__UR2:
                # UR message is CBOR(bstr(psbt)) (BCR-2020-006 / Paytaca).
                # Passing raw .cbor into parse_psbt raises "invalid PSBT magic".
                return bytearray(unwrap_psbt_cbor(self.decoder.result_message().cbor))
